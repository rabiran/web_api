...
informationRouter.post('/information', ValidateRequest(getInformationRequestSchema), wrapValidator(InformationValidator.dataSourceExistence), wrapController(InformationController.getInformation));
